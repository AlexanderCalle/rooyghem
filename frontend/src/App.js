...
import Oudercomité from "./pages/Oudercomité";
    ...
    <Router>
      <body>
        <Switch>
          ...
          <Route exact path="/oc" component={Oudercomité} />
          ...
          <Route
            exact
            path="/wafelbak/:order_id"
            component={WafelbakRewardPage}
          />
          <Route
            exact
            path="/albums/groups/:group_name/:album_id"
          ...
          <PrivateRoute
            ...
            component={BackofficeCreateAct}
          />
          <PrivateRoute
            path="/backoffice/activities/delete/:activity_id"
            component={BackofficeActivityDelete}
          />
          <PrivateRoute
            path="/backoffice/activities/update/:activity_id"
            component={BackofficeUpdateAct}
          />
          {/* Backoffice Albums */}
          <PrivateRoute
            exact
            path="/backoffice/albums"
            component={BackofficeAlbums}
          />
          <PrivateRoute
            exact
            path="/backoffice/albums/create"
            component={BackofficeCreateAlbum}
          />
          <PrivateRoute
            exact
            path="/backoffice/albums/album/update/:album_id"
            component={BackofficeAlbumUpdate}
          />
          <PrivateRoute
            exact
            path="/backoffice/albums/album/:album_id"
            component={BackofficeAlbumPhoto}
          />
          {/* Backoffice VK */}
          <PrivateRoute
            exact
            path="/backoffice/vk"
            component={BackofficeVkPage}
          />
          {/* Backoffice Profile */}
          <PrivateRoute
            exact
          ...
          <PrivateRoute
            exact
            path="/backoffice/profile/update"
            component={BackofficeUpdateProfile}
          />
          {/* Backoffice Admin Section */}
          {/* Backoffice Newsfeed (Admin) */}
          <AdminRoute
            exact
            path="/backoffice/newsfeed"
            component={BackofficeNewsfeed}
          />
          <AdminRoute
            exact
            path="/backoffice/newsfeed/create"
            component={BackofficeNewsfeedCreate}
          />
          <AdminRoute
            path="/backoffice/newsfeed/update/:newsfeed_id"
            component={BackofficeNewsfeedUpdate}
          />
          <AdminRoute
            path="/backoffice/newsfeed/delete/:newsfeed_id"
            component={BackofficeNewsfeedDelete}
          />
          {/* Backoffice Albums Checker (Admin) */}
          <AdminRoute
            exact
            path="/backoffice/albums/checker"
            component={BackofficeAlbumChecker}
          />
          <AdminRoute
            exact
            path="/backoffice/albums/check/:album_id"
            component={BackofficePhotoCheck}
          />
          ...
          <AdminRoute
            ...
            component={BackofficeUsersCreate}
          />
          <AdminRoute
            exact
            path="/backoffice/users/update/:user_id"
            component={BackofficeUsersUpdate}
          />
          <AdminRoute
            exact
            path="/backoffice/users/delete/:user_id"
            component={BackofficeUsersDelete}
          />
          {/* Backoffice All Activities (Admin) */}
          <AdminRoute
            exact
            path="/backoffice/activities/allactivities"
            component={BackofficeAllActivities}
          />
          {/* Backoffice All Vk (Admin) */}
          <AdminRoute
            exact
            path="/backoffice/vk/allvk"
            component={BackofficeAllVk}
          />
          <AdminRoute
            exact
            path="/backoffice/vk/allvk/update/:group_id"
            component={BackofficeAllVkUpdate}
          />
          {/* Backoffice Wafelbak Orders (Admin) */}
          <AdminRoute
            exact
            path="/backoffice/wafelbak/orders"
            component={BackofficeWafelbakPage}
          />
        </Switch>
      </body>
    </Router>
